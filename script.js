...
document.addEventListener('DOMContentLoaded', function() {
    ...
    'Proxy & Network Workflow Engineer',
    'Tech Problem Solver'
    ];
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            fetch("https://formsubmit.co/ajax/inayeemabdullah@gmail.com", {
                method: "POST",
                headers: { 
    ...
    // Characters to rain down (Binary + Hex for that "Data" look)
    const chars = '01010101010F0E0D0C0B0A987654321';
    ...
    function drawRain() {
        ...
        // Set text color (Your Neon Cyan)
        ctx.fillStyle = '#094757ff'; 
